# Disclaimer & Acceptable Use — namba-search

`namba-search` is inspired by Insane Search and is distributed under the
[MIT License](./LICENSE).
Copyright (c) 2026 Namba Search contributors.
...
`namba-search` is a general-purpose developer tool. Like most general-purpose tools, it
...
## 6. Scope of access (specific to namba-search)

`namba-search` is a reader for **publicly available content only**. By design it stops
