...
from insane_search.persistence.paths import ensure_private_dir, user_data_dir
from insane_search.persistence.locks import file_lock
...
def default_path() -> str:
    ...
    if p:
        return p
    return str(ensure_private_dir(user_data_dir() / "state") / "learned.json")
